...
exports.useStoreContext = exports.StoreProvider = void 0;
var _react = _interopRequireWildcard(require("react"));
var _reducers = require("./reducers");
var _excluded = ["value"]; // import React, { createContext, useContext, useReducer } from "react";
...
var StoreProvider = function StoreProvider(_ref) {
  ...
  var _useProductReducer = (0, _reducers.useProductReducer)({
      products: [],
      cart: [],
      cartOpen: false,
      categories: [],
    ...
    _useProductReducer2 = _slicedToArray(_useProductReducer, 2),
    state = _useProductReducer2[0],
    dispatch = _useProductReducer2[1];
