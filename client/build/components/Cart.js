...
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; } // import React, { useEffect } from 'react';
...
var stripePromise = (0, _stripeJs.loadStripe)('pk_test_TYooMQauvdEDq54NiTphI7jx');
var Cart = function Cart() {
  ...
  (0, _react.useEffect)(function () {
    ...
    function _getCart() {
      _getCart = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var cart;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _helpers.idbPromise)('cart', 'get');
            case 2:
              cart = _context.sent;
              dispatch({
                type: _actions.ADD_MULTIPLE_TO_CART,
                products: _toConsumableArray(cart)
              });
            case 4:
            case "end":
  ...
  function submitCheckout() {
    var productIds = [];
    state.cart.forEach(function (item) {
      for (var i = 0; i < item.purchaseQuantity; i++) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "close",
    onClick: toggleCart
  }, "[close]"), /*#__PURE__*/_react.default.createElement("h2", null, "Services In Your Cart"), state.cart.length ? /*#__PURE__*/_react.default.createElement("div", null, state.cart.map(function (item) {
  ...
  }, /*#__PURE__*/_react.default.createElement("strong", null, "Total: $", calculateTotal()), _auth.default.loggedIn() ? /*#__PURE__*/_react.default.createElement("button", {
    onClick: submitCheckout
  }, "Checkout") : /*#__PURE__*/_react.default.createElement("span", null, "(log in to check out)"))) : /*#__PURE__*/_react.default.createElement("h3", null, /*#__PURE__*/_react.default.createElement("span", {
    role: "img",
    "aria-label": "shocked"
